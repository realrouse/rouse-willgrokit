...
| [**Executable experiment (archived here)**](./experiments/browser-superpeer/) | 2026-08-12 | First superpeer prototype (download). **Active development:** [realrouse/lbry-rs](https://github.com/realrouse/lbry-rs) — crates + upload + web companion |
